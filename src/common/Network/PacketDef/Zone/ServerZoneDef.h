...
struct FFXIVIpcInitUI : FFXIVIpcBasePacket<InitUI>
{
   ...
   unsigned char unknownMask4Padding[4];
   ...
   unsigned char unknown61E[20];
   unsigned char unknown61F[29];
   unsigned char unknown63F[5];
