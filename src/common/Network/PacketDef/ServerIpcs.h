...
namespace Sapphire::Network::Packets
{
  ...
  */
    ...
    enum ServerZoneIpcType : uint16_t
    {
        ...
        UpdateContent = 0x007B, // was 0x02E4
        SuccessFindContentAsMember5 = 0x007C, // was 0x02E6
        Unknown_5 = 0x007D,
        Unknown_6 = 0x007F,
        FinishContentMatchToClient = 0x0080, // was 0x0339
        AllienceInviteUpdate = 0x0082, // was 0x007A
        Unknown_0083 = 0x0083, // old 0x7B
        Unknown_0084 = 0x0084, // old 0x7C
        Unknown_7 = 0x0085,
        Unknown_8 = 0x0086,
        Unknown_9 = 0x0087,
        Unknown_10 = 0x0088,
        ...
        Unknown_33 = 0x00B7,
        Unknown_00B7 = 0x00B7, // old 0xE4
        Unknown_34 = 0x00B8,
        Unknown_00B8 = 0x00B8, // old 0xE5
        FriendlistRemoveResult = 0x00B9, // was 0x00E6
        Unknown_35 = 0x00BA,
        Unknown_00BA = 0x00BA, // old 0xE7
        ...
        Unknown_00D9 = 0x00D9, // old 0x11B
        Unknown_00DA = 0x00DA, // old 0x11C
        LeaveNoviceNetwork = 0x00DB, // was 0x011D
        Unknown_36 = 0x00DC,
        Unknown_37 = 0x00DD,
        ...
        Unknown_00E3 = 0x00E3, // old 0x14E
        GrandCompany = 0x00E4, // was 0x014F
        Unknown_00E5 = 0x00E5, // old 0x150
        Unknown_00E6 = 0x00E6, // old 0x151
        Unknown_00E7 = 0x00E7, // old 0x152
        Unknown_00E8 = 0x00E8, // old 0x153
        Unknown_00E9 = 0x00E9, // old 0x154
        Unknown_00EA = 0x00EA, // old 0x155
        Unknown_00EB = 0x00EB, // old 0x156
        Unknown_00EC = 0x00EC, // old 0x157
        Unknown_00ED = 0x00ED, // old 0x158
        Unknown_00EE = 0x00EE, // old 0x159
        Unknown_00EF = 0x00EF, // old 0x15A
        Unknown_00F0 = 0x00F0, // old 0x15B
        Unknown_00F1 = 0x00F1, // old 0x168
        Unknown_00F2 = 0x00F2, // old 0x169
        Unknown_00F3 = 0x00F3, // old 0x16A
        ActorMove = 0x00F4, // was 0x0192
        Transfer = 0x00F5, // was 0x0193
        Warp = 0x00F6, // was 0x0194
        Unknown_00F7 = 0x00F7, // old 0x195
        RequestCast = 0x00F8, // was 0x0196
        Unknown_00F9 = 0x00F9, // old 0x197
        ...
        UpdateEventScene4 = 0x0123, // was 0x01D0
        UpdateEventScene8 = 0x0124, // was 0x01D1
        UpdateEventScene16 = 0x0125, // was 0x01D2
        UpdateEventScene32 = 0x0126, // was 0x01D3
        UpdateEventScene64 = 0x0127, // was 0x01D4
        UpdateEventScene128 = 0x0128, // was 0x01D5
        ...
        ResumeEventScene8 = 0x014B, // was 0x01D9
        ResumeEventScene16 = 0x014C, // was 0x01DA
        ResumeEventScene32 = 0x014D, // was 0x01DB
        ResumeEventScene64 = 0x014E, // was 0x01DC
        ResumeEventScene128 = 0x014F, // was 0x01DD
        ...
        Create = 0x0190, // was 0x0190
        Delete = 0x0191, // was 0x0191
        ...
        Unknown_01CF = 0x01CF, // old 0x30A
        Unknown_01D0 = 0x01D0, // old 0x30B
        Unknown_01D1 = 0x01D1, // old 0x30C
        Unknown_01D2 = 0x01D2, // old 0x30D
        Unknown_01D3 = 0x01D3, // old 0x30E
        Unknown_01D4 = 0x01D4, // old 0x30F
        Unknown_01D5 = 0x01D5, // old 0x310
        ...
        Unknown_01E2 = 0x01E2, // old 0x32F
        Unknown_01E3 = 0x01E3, // old 0x330
        Unknown_01E4 = 0x01E4, // old 0x331
        Unknown_01E5 = 0x01E5, // old 0x332
        Unknown_01E6 = 0x01E6, // old 0x333
        ...
        Unknown_01EB = 0x01EB, // old 0x338
        Unknown_01EC = 0x01EC, // old 0x33A
        UnMountLink = 0x01ED, // was 0x033E
        Unknown_01EE = 0x01EE, // old 0x33F
        Unknown_01EF = 0x01EF, // old 0x348
        Unknown_01F0 = 0x01F0, // old 0x349
        Unknown_01F1 = 0x01F1, // old 0x34A
        Unknown_01F2 = 0x01F2, // old 0x34B
        Unknown_01F3 = 0x01F3, // old 0x34C
        Unknown_01F4 = 0x01F4, // old 0x34D
        Unknown_01F5 = 0x01F5, // old 0x34E
        Unknown_01F6 = 0x01F6, // old 0x34F
        Unknown_01F7 = 0x01F7, // old 0x350
        Unknown_01F8 = 0x01F8, // old 0x351
        Unknown_01F9 = 0x01F9, // old 0x352
        Unknown_01FA = 0x01FA, // old 0x353
        Unknown_01FB = 0x01FB, // old 0x354
        Unknown_01FC = 0x01FC, // old 0x355
        Unknown_01FD = 0x01FD, // old 0x356
        Unknown_01FE = 0x01FE, // old 0x357
        Unknown_01FF = 0x01FF, // old 0x358
        Unknown_0200 = 0x0200, // old 0x359
        ResumeEventScene4 = 0x0201, // was 0x0201
        Unknown_0201 = 0x0201, // old 0x35A
        Unknown_0202 = 0x0202, // old 0x35B
        Unknown_0203 = 0x0203, // old 0x35C
        Unknown_0204 = 0x0204, // old 0x35D
        Unknown_0205 = 0x0205, // old 0x35E
        Unknown_020B = 0x020B, // old 0x384
        Unknown_020E = 0x020E, // old 0x385
        Unknown_020F = 0x020F, // old 0x386
        Unknown_0215 = 0x0215, // old 0x387
        Unknown_0216 = 0x0216, // old 0x388
        Unknown_0217 = 0x0217, // old 0x389
        Unknown_0218 = 0x0218, // old 0x38A
    };
