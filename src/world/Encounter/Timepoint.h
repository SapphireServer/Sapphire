...
namespace Sapphire
{
  ...
  public:
    ...
    bool update( TimepointState& state, TimelineActor& self, TimelinePack& pack, EncounterPtr pEncounter, uint64_t time ) const;
    bool execute( TimepointState& state, TimelineActor& self, TimelinePack& pack, EncounterPtr pEncounter, uint64_t time ) const;
  };
