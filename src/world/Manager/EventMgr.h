...
namespace Sapphire::World::Manager
{
  ...
  public:
    ...
    uint32_t getActorBaseId( uint32_t eventActorId );
    ...
    void handleYieldStringEventScene( Entity::Player& player, uint32_t eventId, uint16_t sceneId, uint8_t resumeId,
    ...
    void handleReturnStringEventScene( Entity::Player& player, uint32_t eventId, uint16_t sceneId,
                                       const std::string& resultString );

    void handleReturnIntAndStringEventScene( Entity::Player& player, uint32_t eventId, uint16_t sceneId,
                                             const std::string& resultString, uint64_t resultInt );
    ...
    void eventStart( Entity::Player& player, uint64_t actorId, uint32_t eventId,
    ...
    void eventActionStart( Entity::Player& player, uint32_t eventId, uint32_t action,
    ...
    void eventItemActionStart( Entity::Player& player, uint32_t eventId, uint32_t action, uint32_t sequence,
                               uint64_t targetId );

    bool checkHitEobject( Entity::Player& player, Common::Vector3 targetPos, Common::QuestEobject Eobject );

    void playGilShop( Entity::Player& player, uint32_t eventId, uint32_t flags, uint32_t param1,
    ...
    /*! resume a subevent */
    void resumeScene( Entity::Player& player, uint32_t eventId, uint32_t scene, uint8_t yieldId,
                      std::vector< uint32_t > values );
    ...
    void sendEventNotice( Entity::Player& player, uint32_t eventId, int8_t noticeId, uint8_t numOfArgs = 0,
