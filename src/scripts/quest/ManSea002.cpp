...
class ManSea002 : public Sapphire::ScriptAPI::QuestScript
{
  ...
  {
    eventMgr().playQuestScene( player, getId(), 2, NO_DEFAULT_CAMERA | HIDE_HOTBAR, bindSceneReturn( &ManSea002::Scene00002Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 7, FADE_OUT | CONDITION_CUTSCENE | HIDE_UI, bindSceneReturn( &ManSea002::Scene00007Return ) );
  }
