...
class ManWil004 : public Sapphire::ScriptAPI::QuestScript
{
  private:
    ...
    /// Countable Num: 1 Seq: 1 Event: 1 Listener: 1002279
    ...
    static constexpr auto Actor1 = 1002279; // Yayake ( Pos: -196.886993 18.459999 59.952599  Teri: 130 )
  ...
  {
    eventMgr().playQuestScene( player, getId(), 0, HIDE_HOTBAR, bindSceneReturn( &ManWil004::Scene00000Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 1, NO_DEFAULT_CAMERA | HIDE_HOTBAR, bindSceneReturn( &ManWil004::Scene00001Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 2, FADE_OUT | CONDITION_CUTSCENE | HIDE_UI, bindSceneReturn( &ManWil004::Scene00002Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 3, HIDE_HOTBAR, bindSceneReturn( &ManWil004::Scene00003Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 4, HIDE_HOTBAR, bindSceneReturn( &ManWil004::Scene00004Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 5, FADE_OUT | CONDITION_CUTSCENE | HIDE_UI, bindSceneReturn( &ManWil004::Scene00005Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 6, NONE, bindSceneReturn( &ManWil004::Scene00006Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 7, NONE, bindSceneReturn( &ManWil004::Scene00007Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 8, FADE_OUT | CONDITION_CUTSCENE | HIDE_UI, bindSceneReturn( &ManWil004::Scene00008Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 50, FADE_OUT | HIDE_UI, bindSceneReturn( &ManWil004::Scene00050Return ) );
  }
