...
class ClsThm021 : public Sapphire::ScriptAPI::QuestScript
{
  private:
    ...
    static constexpr auto Actor0 = 1001708; // Cocobuki ( Pos: -250.347000 18.000000 80.903603  Teri: 130 )
  ...
  public:
    ClsThm021() : Sapphire::ScriptAPI::QuestScript( 65882 ){}; 
    ~ClsThm021() = default; 
  ...
  {
    eventMgr().playQuestScene( player, getId(), 0, HIDE_HOTBAR, bindSceneReturn( &ClsThm021::Scene00000Return ) );
  }
  ...
  {
    eventMgr().playQuestScene( player, getId(), 1, HIDE_HOTBAR, bindSceneReturn( &ClsThm021::Scene00001Return ) );
  }
