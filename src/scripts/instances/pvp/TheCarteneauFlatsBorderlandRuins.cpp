...
class TheCarteneauFlatsBorderlandRuins : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheCarteneauFlatsBorderlandRuins() : Sapphire::ScriptAPI::InstanceContentScript( 50002 )
  { }
...
EXPOSE_SCRIPT( TheCarteneauFlatsBorderlandRuins );