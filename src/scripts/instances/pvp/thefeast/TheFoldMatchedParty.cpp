...
class TheFoldMatchedParty : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheFoldMatchedParty() : Sapphire::ScriptAPI::InstanceContentScript( 40005 )
  { }
...
EXPOSE_SCRIPT( TheFoldMatchedParty );