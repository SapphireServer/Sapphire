...
class TheFeastTeamCustomMatchCrystalTower :
  public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheFeastTeamCustomMatchCrystalTower() :
    Sapphire::ScriptAPI::InstanceContentScript( 40026 )
  { }
...
EXPOSE_SCRIPT( TheFeastTeamCustomMatchCrystalTower );