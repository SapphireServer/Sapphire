...
class TheFoldLightParty : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheFoldLightParty() : Sapphire::ScriptAPI::InstanceContentScript( 40006 )
  { }
...
EXPOSE_SCRIPT( TheFoldLightParty );