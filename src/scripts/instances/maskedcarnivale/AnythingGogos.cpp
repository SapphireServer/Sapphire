...
class AnythingGogos : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AnythingGogos() : Sapphire::ScriptAPI::InstanceContentScript( 35031 )
  { }
