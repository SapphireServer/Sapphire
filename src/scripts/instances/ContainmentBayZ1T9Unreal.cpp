...
class ContainmentBayZ1T9Unreal : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  ContainmentBayZ1T9Unreal() : Sapphire::ScriptAPI::InstanceContentScript( 64007 )
  { }

  void onInit( InstanceContent& instance ) override
  {
    instance.registerEObj( "unknown_0", 2007716, 0, 4, { 11.420000f, 0.000004f, 11.783210f }, 1.000000f, 0.000000f); 
    instance.registerEObj( "unknown_1", 2007717, 0, 4, { -11.656410f, -0.000002f, 12.218210f }, 1.000000f, 0.000000f); 
    instance.registerEObj( "unknown_2", 2007718, 0, 4, { -17.805031f, 0.000000f, 4.207765f }, 1.000000f, 0.000000f); 
    instance.registerEObj( "unknown_3", 2007719, 0, 4, { 5.447040f, 0.000002f, -9.308832f }, 1.000000f, 0.000000f); 
    instance.registerEObj( "unknown_4", 2007720, 0, 4, { 9.576125f, 0.000002f, -3.402662f }, 1.000000f, 0.000000f); 
...
EXPOSE_SCRIPT( ContainmentBayZ1T9Unreal );