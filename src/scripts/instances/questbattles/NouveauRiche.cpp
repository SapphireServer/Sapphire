...
public:
  ...
  void onInit( QuestBattle& instance ) override
  {
    ...
    instance.addEObj( "蛛ｽ騾蜩・ｼ井ｻ・・", 2001513, 0, 4055157, 4, { -216.996704f, 2.351378f, -106.347504f }, 0.991760f, 0.000048f, 0); 
    instance.addEObj( "蛛ｽ騾蜩・ｼ井ｻ・雲1", 2001513, 0, 4055416, 4, { -230.467896f, 1.016571f, -80.124969f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "蛛ｽ騾蜩・ｼ井ｻ・雲2", 2001513, 0, 4055417, 4, { -193.487503f, 3.305519f, -105.677299f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "蛛ｽ騾蜩・ｼ井ｻ・雲3", 2001513, 0, 4055418, 4, { -197.272202f, 2.239987f, -83.755989f }, 0.991760f, 0.000048f, 0); 
    instance.addEObj( "蛛ｽ騾蜩・ｼ井ｻ・雲4", 2001513, 0, 4055419, 4, { -171.876205f, 1.443221f, -46.679409f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "蛛ｽ騾蜩・ｼ井ｻ・雲5", 2001513, 0, 4055420, 4, { -172.634094f, 2.128752f, -90.899872f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "蛛ｽ騾蜩・ｼ井ｻ・雲6", 2001513, 0, 4055421, 4, { -175.727707f, 2.985368f, -116.684196f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "蛛ｽ騾蜩・ｼ井ｻ・雲7", 2001513, 0, 4055423, 4, { -193.761200f, 2.448251f, -55.852360f }, 1.000000f, 0.000000f, 0); 
