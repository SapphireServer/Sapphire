...
class ExecuteaCombotoIncreaseEnmity : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  ExecuteaCombotoIncreaseEnmity() : Sapphire::ScriptAPI::InstanceContentScript( 15002 )
  { }
