...
class AccrueEnmityfromMultipleTargets : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AccrueEnmityfromMultipleTargets() : Sapphire::ScriptAPI::InstanceContentScript( 15004 )
  { }
