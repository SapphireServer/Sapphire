...
class EngageEnemyReinforcements : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  EngageEnemyReinforcements() : Sapphire::ScriptAPI::InstanceContentScript( 15011 )
  { }
