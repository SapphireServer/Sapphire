...
class ExecuteaRangedAttacktoIncreaseEnmity : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  ExecuteaRangedAttacktoIncreaseEnmity() : Sapphire::ScriptAPI::InstanceContentScript( 15006 )
  { }
