...
class AssistAlliesinDefeatingaTarget : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AssistAlliesinDefeatingaTarget() : Sapphire::ScriptAPI::InstanceContentScript( 15008 )
  { }
