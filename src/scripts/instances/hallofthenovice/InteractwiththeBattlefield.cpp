...
class InteractwiththeBattlefield : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  InteractwiththeBattlefield() : Sapphire::ScriptAPI::InstanceContentScript( 15012 )
  { }
