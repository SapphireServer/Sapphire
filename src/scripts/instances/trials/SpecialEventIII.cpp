...
class SpecialEventIII : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  SpecialEventIII() : Sapphire::ScriptAPI::InstanceContentScript( 20016 )
  { }
