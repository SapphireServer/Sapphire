...
class TheCloudDeck : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheCloudDeck() : Sapphire::ScriptAPI::InstanceContentScript( 20075 )
  { }
