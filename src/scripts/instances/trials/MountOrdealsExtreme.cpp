...
class MountOrdealsExtreme : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  MountOrdealsExtreme() : Sapphire::ScriptAPI::InstanceContentScript( 20087 )
  { }
...
EXPOSE_SCRIPT( MountOrdealsExtreme );