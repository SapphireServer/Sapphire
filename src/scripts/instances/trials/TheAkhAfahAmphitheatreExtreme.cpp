...
class TheAkhAfahAmphitheatreExtreme : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheAkhAfahAmphitheatreExtreme() : Sapphire::ScriptAPI::InstanceContentScript( 20025 )
  { }
...
EXPOSE_SCRIPT( TheAkhAfahAmphitheatreExtreme );