...
class TheMinstrelsBalladEndsingersAria : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheMinstrelsBalladEndsingersAria() : Sapphire::ScriptAPI::InstanceContentScript( 20083 )
  { }
...
EXPOSE_SCRIPT( TheMinstrelsBalladEndsingersAria );