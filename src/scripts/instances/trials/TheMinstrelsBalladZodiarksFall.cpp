...
class TheMinstrelsBalladZodiarksFall : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheMinstrelsBalladZodiarksFall() : Sapphire::ScriptAPI::InstanceContentScript( 20081 )
  { }
...
EXPOSE_SCRIPT( TheMinstrelsBalladZodiarksFall );