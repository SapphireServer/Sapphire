...
class EventContents1 : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  EventContents1() : Sapphire::ScriptAPI::InstanceContentScript( 20015 )
  { }
