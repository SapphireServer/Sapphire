...
class EventContents3 : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  EventContents3() : Sapphire::ScriptAPI::InstanceContentScript( 20014 )
  { }
