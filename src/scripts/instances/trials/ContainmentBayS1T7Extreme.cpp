...
class ContainmentBayS1T7Extreme : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  ContainmentBayS1T7Extreme() : Sapphire::ScriptAPI::InstanceContentScript( 20038 )
  { }
