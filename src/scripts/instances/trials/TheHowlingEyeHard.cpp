...
class TheHowlingEyeHard : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheHowlingEyeHard() : Sapphire::ScriptAPI::InstanceContentScript( 20006 )
  { }
...
EXPOSE_SCRIPT( TheHowlingEyeHard );