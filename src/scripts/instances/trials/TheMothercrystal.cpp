...
class TheMothercrystal : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheMothercrystal() : Sapphire::ScriptAPI::InstanceContentScript( 20077 )
  { }
...
EXPOSE_SCRIPT( TheMothercrystal );