...
class TheVoidcastDaisExtreme : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheVoidcastDaisExtreme() : Sapphire::ScriptAPI::InstanceContentScript( 20090 )
  { }
...
EXPOSE_SCRIPT( TheVoidcastDaisExtreme );