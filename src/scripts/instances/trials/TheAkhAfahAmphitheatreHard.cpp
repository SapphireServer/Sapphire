...
class TheAkhAfahAmphitheatreHard : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheAkhAfahAmphitheatreHard() : Sapphire::ScriptAPI::InstanceContentScript( 20024 )
  { }
...
EXPOSE_SCRIPT( TheAkhAfahAmphitheatreHard );