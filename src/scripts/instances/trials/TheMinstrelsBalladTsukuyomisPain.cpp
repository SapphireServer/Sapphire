...
class TheMinstrelsBalladTsukuyomisPain :
  public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  TheMinstrelsBalladTsukuyomisPain() :
    Sapphire::ScriptAPI::InstanceContentScript( 20056 )
  { }
...
EXPOSE_SCRIPT( TheMinstrelsBalladTsukuyomisPain );