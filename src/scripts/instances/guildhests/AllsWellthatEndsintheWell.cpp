...
class AllsWellthatEndsintheWell : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AllsWellthatEndsintheWell() : Sapphire::ScriptAPI::InstanceContentScript( 10007 )
  { }
