...
class AnotherSildihnSubterrane : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AnotherSildihnSubterrane() : Sapphire::ScriptAPI::InstanceContentScript( 37001 )
  { }
...
EXPOSE_SCRIPT( AnotherSildihnSubterrane );