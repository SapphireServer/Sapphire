        ...
        switch( v4 )
        {
          ...
          case 2:
          {
            if( dt >= 1 + v4 * 7 )
            {
              ...
              FFXIVIpcDirectorPopUp2 packetData = {};
              ...
              //packetData.param[2] = static_cast< uint32_t >(instance.getCustomVar(2));
              instance.foreachPlayer( [ &instance, &packetData ]( auto p )
                {
                  auto packet = makeZonePacket< FFXIVIpcDirectorPopUp2 >( p->getId() );
        ...
        switch( v4 )
        {
          ...
          case 4:
          {
            if( dt >= 28 )
            {
              ...
              instance.foreachPlayer( [ &instance ]( auto p )
                {
                  auto packet = makeZonePacket< FFXIVDirectorMsg4 >( p->getId() );
