...
public:
  ...
  void onInit( InstanceContent& instance ) override
  {
    ...
    pEObj->addCollisionBox( { -35.299999, 29.043749, 60.799999 }, 0.000000, 7.260001, 5.795626, 0.300003 );
    ...
    pEObj->addCollisionBox( { -158.546890, 11.053966, 214.344666 }, 0.000000, 3.088758, 3.731382, 0.510000 );
  ...
  void onTalk( InstanceContent& instance, Entity::Player& player, Entity::EventObject& eobj, uint32_t eventId ) override
  {
    ...
    if( eobj.getName() == "Inconspicuousswitch" )
    {
      ...
      if( pEncounter == nullptr || pEncounter->getId() < ENCOUNTER_CHOPPER )
      {
        ...
        setup.lockoutEntrances = { { "sgvf_w_lvd_b0250", 2001504, 4323996, 4036038, 4, { 94.597588f, 26.865030f, -68.584061f }, 1.000000f, 0.000000f, 0 } };
        setup.lockoutExits = { {} };
