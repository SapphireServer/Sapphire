...
public:
  ...
  void onInit( InstanceContent& instance ) override
  {
    ...
    // States -> vf_bextwall_on (id: 3) vf_bextwall_of (id: 4) 
    instance.addEObj( "ブレイフロクス�抜道", 2003429, 0, 4663860, 4, { 44.358749f, 7.554582f, -132.341095f }, 1.000000f, 0.000000f, 0); 
    ...
    // States -> vf_bextwall_on (id: 3) vf_bextwall_of (id: 4) 
    instance.addEObj( "unknown_8", 2002735, 0, 4543737, 4, { -48.271229f, 34.918541f, -235.574203f }, 1.000000f, -1.497719f, 0); 
