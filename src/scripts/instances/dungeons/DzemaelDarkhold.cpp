...
public:
  ...
  {
    instance.addEObj( "埋門", 2000033, 3328371, 4229633, 4, { 79.909241f, 1.268266f, 161.509598f }, 1.000000f, 0.000000f, 0); 
    ...
    instance.addEObj( "unknown_0", 2000453, 0, 4229636, 4, { 79.384338f, -10.733530f, 106.701599f }, 1.000000f, -0.706750f, 0); 
    ...
    // States -> vfbright_b_on (id: 5) vfbright_b_off (id: 6) 
    instance.addEObj( "unknown_1", 2000279, 4247600, 4260481, 4, { 35.302368f, 8.108457f, 206.288605f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_2", 2000279, 4247601, 4260542, 4, { 111.093102f, -3.403727f, 176.495895f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_3", 2000279, 4247603, 4260592, 4, { 68.310699f, -14.257320f, 83.756592f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_4", 2000279, 4247604, 4260596, 4, { 52.317631f, -11.815490f, 110.621300f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_5", 2000279, 4247605, 4260597, 4, { 18.860821f, -14.036660f, 88.283234f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_6", 2000279, 4247606, 4260598, 4, { 20.972610f, -11.172370f, 51.726391f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_7", 2000279, 4247602, 4260625, 4, { 138.802094f, -10.764680f, 110.383400f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "Magitektransporter_1", 2000474, 0, 4233741, 4, { -96.800278f, -30.000010f, -41.821941f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_8", 2000455, 0, 4233742, 4, { -106.309601f, -26.688049f, -16.372990f }, 0.991760f, 0.737616f, 0); 
    instance.addEObj( "sgvf_w_lvd_b0118_1", 2000454, 4233746, 4233744, 4, { -107.679703f, -26.639919f, -15.815070f }, 1.000000f, 0.000000f, 0); 
    // States -> vf_bextwall_on (id: 3) vf_bextwall_of (id: 4) 
    instance.addEObj( "unknown_9", 2000487, 4184823, 4233750, 4, { -111.157799f, -22.833250f, 2.271249f }, 1.000000f, 0.000000f, 0); 
    ...
    // States -> vfbright_o_on (id: 5) vfbright_o_off (id: 6) 
    instance.addEObj( "unknown_10", 2000280, 4247607, 4260626, 4, { -260.415710f, -25.404510f, -36.083500f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_11", 2000280, 4247608, 4260627, 4, { -262.467896f, -26.663879f, -21.408119f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_12", 2000280, 4247609, 4260641, 4, { -241.470901f, -24.060431f, -29.972530f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_13", 2000280, 4247611, 4260649, 4, { -238.320496f, -47.903111f, -3.008399f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_14", 2000280, 4247610, 4260650, 4, { -219.957108f, -17.854340f, 18.911011f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_15", 2000280, 4247613, 4260651, 4, { -168.223907f, -33.658329f, 50.704330f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_16", 2000280, 4247612, 4260652, 4, { -165.114899f, -32.678890f, 41.844219f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_17", 2000280, 4247614, 4260654, 4, { -133.651001f, -24.416229f, 10.934760f }, 1.000000f, 0.000000f, 0); 
    ...
    // States -> vf_tarmn1_on (id: 3) vf_tarmn1_of (id: 4) vf_tarmn2_on (id: 12) vf_bg_on (id: 18) vf_bg_of (id: 28) 
    instance.addEObj( "unknown_18", 2000457, 0, 4233769, 4, { 56.778809f, -36.148682f, -150.835495f }, 0.991760f, 0.957075f, 0); 
    ...
    // States -> vfbright_o_on (id: 5) vfbright_o_off (id: 6) 
    instance.addEObj( "unknown_19", 2000280, 4246846, 4260657, 4, { -45.950432f, -19.312410f, -177.762207f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_20", 2000280, 4246848, 4260659, 4, { -14.610830f, -21.218700f, -145.140900f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_21", 2000280, 4246847, 4260660, 4, { -16.411739f, -16.383909f, -180.914902f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_22", 2000280, 4246849, 4260661, 4, { 26.993160f, -23.453131f, -107.682999f }, 0.991760f, 0.000048f, 0); 
    instance.addEObj( "unknown_23", 2000280, 0, 4260662, 4, { 32.493099f, -24.000099f, -113.021797f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_24", 2000280, 4246850, 4260663, 4, { 66.021332f, -38.500019f, -172.238098f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_25", 2000280, 4246851, 4260664, 4, { 70.452782f, -37.655048f, -202.913803f }, 1.000000f, 0.000000f, 0); 
    instance.addEObj( "unknown_26", 2000280, 4246852, 4260665, 4, { 103.330498f, -38.100510f, -159.167999f }, 1.000000f, 0.000000f, 0); 
