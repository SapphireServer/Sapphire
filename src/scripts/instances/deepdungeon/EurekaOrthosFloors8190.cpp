...
class EurekaOrthosFloors8190 : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  EurekaOrthosFloors8190() : Sapphire::ScriptAPI::InstanceContentScript( 60039 )
  { }
...
EXPOSE_SCRIPT( EurekaOrthosFloors8190 );