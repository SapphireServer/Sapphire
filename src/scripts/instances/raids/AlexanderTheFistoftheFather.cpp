...
class AlexanderTheFistoftheFather : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AlexanderTheFistoftheFather() : Sapphire::ScriptAPI::InstanceContentScript( 30021 )
  { }
