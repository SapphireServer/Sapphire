...
class AsphodelosTheSecondCircle : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AsphodelosTheSecondCircle() : Sapphire::ScriptAPI::InstanceContentScript( 30113 )
  { }
...
EXPOSE_SCRIPT( AsphodelosTheSecondCircle );