...
class AlexanderTheBurdenoftheFatherSavage : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AlexanderTheBurdenoftheFatherSavage() : Sapphire::ScriptAPI::InstanceContentScript( 30028 )
  { }
