...
class AsphodelosTheFirstCircle : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AsphodelosTheFirstCircle() : Sapphire::ScriptAPI::InstanceContentScript( 30111 )
  { }
...
EXPOSE_SCRIPT( AsphodelosTheFirstCircle );