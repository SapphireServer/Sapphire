...
class AsphodelosTheThirdCircle : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AsphodelosTheThirdCircle() : Sapphire::ScriptAPI::InstanceContentScript( 30109 )
  { }
...
EXPOSE_SCRIPT( AsphodelosTheThirdCircle );