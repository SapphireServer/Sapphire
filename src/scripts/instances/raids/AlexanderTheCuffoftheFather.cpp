...
class AlexanderTheCuffoftheFather : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AlexanderTheCuffoftheFather() : Sapphire::ScriptAPI::InstanceContentScript( 30022 )
  { }
...
EXPOSE_SCRIPT( AlexanderTheCuffoftheFather );