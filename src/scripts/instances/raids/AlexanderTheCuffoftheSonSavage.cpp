...
class AlexanderTheCuffoftheSonSavage : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AlexanderTheCuffoftheSonSavage() : Sapphire::ScriptAPI::InstanceContentScript( 30035 )
  { }
