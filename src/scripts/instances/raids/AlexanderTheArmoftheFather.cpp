...
class AlexanderTheArmoftheFather : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AlexanderTheArmoftheFather() : Sapphire::ScriptAPI::InstanceContentScript( 30023 )
  { }
