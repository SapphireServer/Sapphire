...
class AnabaseiosTheTenthCircle : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AnabaseiosTheTenthCircle() : Sapphire::ScriptAPI::InstanceContentScript( 30128 )
  { }
...
EXPOSE_SCRIPT( AnabaseiosTheTenthCircle );