...
class AbyssosTheSeventhCircle : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AbyssosTheSeventhCircle() : Sapphire::ScriptAPI::InstanceContentScript( 30118 )
  { }
...
EXPOSE_SCRIPT( AbyssosTheSeventhCircle );