...
class AnabaseiosTheNinthCircle : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AnabaseiosTheNinthCircle() : Sapphire::ScriptAPI::InstanceContentScript( 30126 )
  { }
...
EXPOSE_SCRIPT( AnabaseiosTheNinthCircle );