...
class AbyssosTheFifthCircleSavage : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AbyssosTheFifthCircleSavage() : Sapphire::ScriptAPI::InstanceContentScript( 30117 )
  { }
...
EXPOSE_SCRIPT( AbyssosTheFifthCircleSavage );