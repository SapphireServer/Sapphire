...
class AbyssosTheEighthCircleSavage : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AbyssosTheEighthCircleSavage() : Sapphire::ScriptAPI::InstanceContentScript( 30123 )
  { }
...
EXPOSE_SCRIPT( AbyssosTheEighthCircleSavage );