...
class AnabaseiosTheTwelfthCircle : public Sapphire::ScriptAPI::InstanceContentScript
{
public:
  AnabaseiosTheTwelfthCircle() : Sapphire::ScriptAPI::InstanceContentScript( 30132 )
  { }
...
EXPOSE_SCRIPT( AnabaseiosTheTwelfthCircle );