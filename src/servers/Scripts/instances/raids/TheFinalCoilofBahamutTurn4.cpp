...
public:
  ...
  void onInit( InstanceContentPtr instance ) override
  {
    ...
    instance->registerEObj( "unknown_3", 2004785, 5039563, 4, { 450.000000f, 0.000000f, 0.000000f }, 1.000000f,
                            0.000000f );
    instance->registerEObj( "unknown_4", 2004649, 5018241, 4, { 448.419403f, 0.000000f, 4.765350f }, 1.000000f,
                            0.000000f );
