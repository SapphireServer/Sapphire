...
class TheCarteneauFlatsHeliodrome : public InstanceContentScript
{
public:
   TheCarteneauFlatsHeliodrome() : InstanceContentScript( 5004 )
   { }
   ...
   void onInit( InstanceContentPtr instance ) override
   {
      ...
      // States -> magic_go magic_down magic_2down magic_on magic_2on 
      instance->registerEObj( "sgbg_l1p1_q3_swhu1_6", 2005084, 5573690, 4, { -0.015320f, -15.426880f, -162.924103f }, 0.991760f, 0.000048f ); 
      // States -> magic_go magic_down magic_2down magic_on magic_2on 
      instance->registerEObj( "sgbg_l1p1_q3_swhu1_7", 2005085, 5573691, 4, { 19.010229f, -15.416970f, -200.015396f }, 1.000000f, 0.000000f ); 
      // States -> magic_go magic_down magic_2down magic_on magic_2on 
      instance->registerEObj( "sgbg_l1p1_q3_swhu1_8", 2005086, 5573692, 4, { -18.994471f, -15.426880f, -199.992905f }, 0.991760f, 0.000048f ); 
      // States -> magic_go magic_down magic_2down magic_on magic_2on 
      instance->registerEObj( "unknown_0", 2004187, 4724282, 4, { -0.007111f, 12.000000f, -386.299896f }, 1.000000f, 0.000000f ); 
      instance->registerEObj( "unknown_1", 2004188, 4724284, 4, { 335.025513f, 12.000000f, 193.711899f }, 1.000000f, 0.000000f ); 
      instance->registerEObj( "unknown_2", 2004189, 4724283, 4, { -334.556213f, 12.000000f, 193.274796f }, 1.000000f, 0.000000f ); 
