...
namespace
{
  MYSQL_STMT* nativeStatement( Mysql::NativeStatementHandle handle )
  {
    return static_cast< MYSQL_STMT* >( handle );
  }
...
Mysql::PreparedResultSet::PreparedResultSet( std::shared_ptr< ResultBind >& pBind,
                                             std::shared_ptr< Mysql::PreparedStatement > par ) : ResultSet( nullptr, par ),
                                                                                                 m_pResultBind( pBind ),
                                                                                                 m_pStmt( par )
{
  pBind->bindResult();
  ...
  auto resMeta = mysql_stmt_result_metadata( nativeStatement( m_pStmt->m_pStmt ) );
...
uint64_t Mysql::PreparedResultSet::getUInt64_intern( const uint32_t columnIndex, bool ) const
{
  ...
  MYSQL_RES* res = mysql_stmt_result_metadata( nativeStatement( m_pStmt->m_pStmt ) );
  ...
  switch( Mysql::Util::mysql_type_to_datatype( field ) )
  {
    ...
    case DataType::BIT:
    {
      ...
      {
        case 8:
          uval = ( uint64_t ) bit_uint8korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 7:
          uval = ( uint64_t ) bit_uint7korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 6:
          uval = ( uint64_t ) bit_uint6korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 5:
          uval = ( uint64_t ) bit_uint5korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 4:
          uval = ( uint64_t ) bit_uint4korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 3:
          uval = ( uint64_t ) bit_uint3korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 2:
          uval = ( uint64_t ) bit_uint2korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 1:
          uval = ( uint64_t ) bit_uint1korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
      }
      return uval;
    }
...
int64_t Mysql::PreparedResultSet::getInt64_intern( const uint32_t columnIndex, bool ) const
{
  ...
  switch( Mysql::Util::mysql_type_to_datatype( field ) )
  {
    ...
    case DataType::BIT:
    {
      ...
      {
        case 8:
          uval = ( int64_t ) bit_uint8korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 7:
          uval = ( int64_t ) bit_uint7korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 6:
          uval = ( int64_t ) bit_uint6korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 5:
          uval = ( int64_t ) bit_uint5korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 4:
          uval = ( int64_t ) bit_uint4korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 3:
          uval = ( int64_t ) bit_uint3korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 2:
          uval = ( int64_t ) bit_uint2korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
        case 1:
          uval = ( int64_t ) bit_uint1korr( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer );
          break;
      }
      return uval;
    }
...
long double Mysql::PreparedResultSet::getDouble( const uint32_t columnIndex ) const
{
  ...
  switch( Mysql::Util::mysql_type_to_datatype( field ) )
  {
    ...
    case DataType::REAL:
    {
      long double ret = !*m_pResultBind->m_pBind[ columnIndex - 1 ].is_null ? *reinterpret_cast< float* >( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer ) : 0.;
      return ret;
    }
    case DataType::DOUBLE:
    {
      long double ret = !*m_pResultBind->m_pBind[ columnIndex - 1 ].is_null ? *reinterpret_cast< double* >( m_pResultBind->m_pBind[ columnIndex - 1 ].buffer ) : 0.;
      return ret;
    }
  }
...
{
  if( nativeStatement( m_pStmt->m_pStmt ) )
    mysql_stmt_free_result( nativeStatement( m_pStmt->m_pStmt ) );
}
